    ...
    JQuery.fn.linhnguyen = function(options) {        
    	...
    	modal.trigger('linhnguyen:open')
			...
			var closeButton = JQuery('.' + options.dismissmodalclass).bind('click.modalEvent', function () {
			  modal.trigger('phuongnguyen:close')
			});
			...
			JQuery('body').keyup(function(e) {
        		if(e.which===27){ modal.trigger('phuongnguyen:close'); } // 27 is the keycode for the Escape key
			});
...
jQuery(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			jQuery("#myModal").html("<a href='https://www.facebook.com/PiaggioVespaVietNam/' target='_blank'><img src='http://www.topcom.com.vn/data/upload/VectorAbstractBlue7BDE97.jpg' width='500px'/><br/>Mua xe vespa</a>. LH: 0988.768.399 <h2><a http://www.topcom.com.vn/data/upload/VectorAbstractBlue7BDE97.jpgclass='close-phuongnguyen-modal'>X</a></h2>");
